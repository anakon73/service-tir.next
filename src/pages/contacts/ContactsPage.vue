    ...
    <div class="container mb-24 lg:mb-32">
      ...
      <div class="mb-10 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <h1
            class="
            whitespace-nowrap font-jakarta text-2xl font-bold
            leading-[26px] text-gray-900 sm:text-big sm:leading-extra-height
            "
          >
            Наші контакти
          </h1>
        </div>
        <SButton class="hidden sm:block">
          Зателефонувати
        </SButton>
      </div>
      <div
        ...
        sm:flex-row sm:items-start sm:gap-[50px] md:gap-[120px]
        "
      >
        ...
        <div class="flex flex-col justify-start gap-2.5">
          ...
          <p
            ...
            :key="phone"
            class="
            leading-7 text-neutral-500 transition-colors
            duration-300 hover:text-neutral-600
            "
          >
        ...
        <div class="flex flex-col justify-start gap-2.5">
          ...
          <p
            ...
            :key="email"
            class="
            leading-7 text-neutral-500 underline
            transition-colors duration-300 hover:text-neutral-600
            "
          >
        ...
        <button
          class="
          block self-start rounded-large bg-blue-600 px-9
          py-3 text-xs font-bold text-white transition-colors
          duration-300 hover:bg-blue-700 hover:text-zinc-100 sm:hidden
          "
        >
          Зателефонувати
        </button>
